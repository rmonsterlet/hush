export class AppConfig {
    ...
    static URL_PREFERENCES = `rest/habilitation/preferences/sauvegarder`
    static URL_STATUTS = `rest/demande/listeStatuts`
    static URL_PRIORITES = `rest/demande/listePriorites`
    static URL_MOTIFS_ANNULATION = `rest/demande/listeMotifsAnnulation`
    static URL_DEMANDES = `rest/demande/listeDemandes`
    static URL_CANCEL_LIST_DEMANDE = `rest/demande/annulerList`
    static URL_RESTORE_LIST_DEMANDE = `rest/demande/restaurerList`
    static URL_EXPORT = `rest/demande/export`
